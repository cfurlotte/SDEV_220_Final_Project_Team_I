...
class GUI:
    def __init__(self):
        ...
        self.pizzaInstructions = tk.Label(self.window, text="Choose the Toppings\nthat you want.")
        self.pizzaInstructions.grid(row=2, column=2, ipadx=25, ipady=10, pady=10, padx=85)
        ...
        self.pizzaSausageOption = tk.Checkbutton(self.window, text = "Sausage", variable=self.temp2, command=lambda: self.SausageBoolean())
        self.pizzaSausageOption.grid(row=4, column=2, ipadx=47, ipady=10, pady=10, padx=85)
        ...
        self.pizzaHamOption = tk.Checkbutton(self.window, text = "Ham", variable=self.temp3, command=lambda: self.HamBoolean())
        self.pizzaHamOption.grid(row=5, column=2, ipadx=56, ipady=10, pady=10, padx=85)
        ...
        self.pizzaMushroomOption = tk.Checkbutton(self.window, text = "Mushroom", variable=self.temp4, command=lambda: self.MushroomBoolean())
        self.pizzaMushroomOption.grid(row=6, column=2, ipadx=39, ipady=10, pady=10, padx=85)
        ...
        self.pizzaOnionsOption = tk.Checkbutton(self.window, text = "Onions", variable=self.temp4, command=lambda: self.OnionsBoolean())
        self.pizzaOnionsOption.grid(row=7, column=2, ipadx=50, ipady=10, pady=10, padx=85)
        ...
        self.pizzaPeppersOption = tk.Checkbutton(self.window, text = "Peppers", variable=self.temp6, command=lambda: self.PeppersBoolean())
        self.pizzaPeppersOption.grid(row=8, column=2, ipadx=48, ipady=10, pady=10, padx=85)
